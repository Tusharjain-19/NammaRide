...
export const stationsMeta = [
  ...
  { id:"G20", name:"National College", name_kn:"ನ್ಯಾಷನಲ್ ಕಾಲೇಜು", code:"G20", line:"Green Line", type:"Underground", platforms:"2", metroInfo:{operator:"BMRCL",opened:"2016"}, facilities:["Toilets","Escalator","Ticket Counter","Wheelchair Access"], connectivity:["BMTC Bus Stop","Auto rickshaw stand"], location:{lat:12.9506,lon:77.5737}},
  { id:"G21", name:"Lalbagh Botanical Garden", name_kn:"ಲಾಲ್ ಬಾಗ್ ಬೊಟಾನಿಕಲ್ ಗಾರ್ಡನ್", code:"G21", line:"Green Line", type:"Underground", platforms:"2", metroInfo:{operator:"BMRCL",opened:"2016"}, facilities:["Toilets","Escalator","Elevator","Ticket Counter","Wheelchair Access"], connectivity:["BMTC Bus Stop","Auto rickshaw stand","Lalbagh Botanical Garden entrance"], location:{lat:12.9497,lon:77.5796}},
