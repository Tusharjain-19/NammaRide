    ...
    <nav className="fixed top-0 w-full h-20 bg-white/90 dark:bg-gray-950/90 backdrop-blur-3xl border-b border-gray-200 dark:border-gray-800 z-50 shadow-sm transition-colors">
      <div className="flex justify-between items-center px-4 sm:px-6 lg:px-8 max-w-container-max mx-auto h-full">
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-full border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800 transition-all flex items-center justify-center"
              title="Toggle Theme"
            >
          ...
          <div className="lg:hidden flex items-center gap-2">
            <button
              onClick={toggleTheme}
              className="p-1.5 rounded-full border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white"
            >
              {theme === 'dark' ? <Sun className="w-4 h-4 text-amber-500" /> : <Moon className="w-4 h-4 text-indigo-500" />}
            </button>
            <button
